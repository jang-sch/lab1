...
void init_opengl(void)
{
    ...
    //added from asteroids to allow fonts
...
void movement()
{
    ...
    for(int i=0; i<g.n; i++) {
        ...
        if (p->s.center.y < 0.0) {
            //cout << "off screen" << endl; changed in class
...
void render()
{
    ...
    //draw the box
    Shape *s;
    glColor3ub(86, 163, 91);
    s = &g.box; //note this area
    glPushMatrix();
    ...
    //
    //Draw your 2D text here, using r from Shapes section
    ggprint8b(&r, 16, 0x005e1663, "Requirements");
